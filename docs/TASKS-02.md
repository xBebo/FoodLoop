# FoodLoop — Tasks 2 of 3 | مهام المرحلة الثانية
...
- بعد تأكيد براء الدمج: اسحبوا develop وابدأوا فرعًا جديدًا بالأسماء أدناه. لا تواصلوا على فروع المرحلة الأولى القديمة.
